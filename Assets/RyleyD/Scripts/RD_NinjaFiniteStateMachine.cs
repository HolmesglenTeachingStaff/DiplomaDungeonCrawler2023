...
public class RD_NinjaFiniteStateMachine : MonoBehaviour
{
    ...
    public enum States { IDLE, PATROLLING, CHASING, MELEEATTACK, RANGEDATTACK, DODGE, FLEEING, DEATH }
    ...
    IEnumerator IDLE()
    {
        ...
        while (currentState == States.IDLE)
        {
            ...
            if (IsInRange(meleeRange)) currentState = States.MELEEATTACK;
    ...
    IEnumerator PATROLLING()
    {
        ...
        {
            if (IsInRange(meleeRange) && Time.time - lastAttack > timeBetweenAttacks) currentState = States.MELEEATTACK;
            else if (IsInRange(sightRange)) currentState = States.CHASING;
            else
            {
